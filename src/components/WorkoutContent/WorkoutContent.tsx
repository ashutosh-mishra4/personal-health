...
import classes from './WorkoutContent.module.css';
...
const WorkoutContent = ({ workouts, currentWorkoutSession, filters: initialFilters, sortOption: initialSortOption }: WorkoutContentProps) => {
